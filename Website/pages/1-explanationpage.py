...
with body2:
    ...
    st.markdown("In the year 1912, the Titanic left from Southampton to New York City, but it never arrived. On April 15, it crashed into an iceberg and sank. Of the estimated 2,224 passengers and crew aboard, more than 1,500 died, making it the deadliest sinking of a single ship up to that time. ")
    ...
    Using Machine Learning (ML) we will show a prediction of whether they would have survived the disaster. 
    ...
    st.markdown('''We know certain \"features\" of the passengers that embarked on the Titanic. A feature describes something about them, for example their age or how much they paid for the ticket. 
