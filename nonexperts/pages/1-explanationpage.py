...
def loadData():
    ...
    url_testnames = "https://raw.githubusercontent.com/A-Jansen/XAI_Titanic/main/nonexperts/assets/test_with_names.csv"
...
with body2:
    ...
    st.image('https://github.com/A-Jansen/XAI_Titanic/blob/main/nonexperts/assets/titanic.jpg?raw=true')
